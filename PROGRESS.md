...
| R15.03 | Define canonical machine-readable validation scenarios. | Partial | Existing fluid-quality cases provide a starting point but lack the recovery manifest contract. | PSIM-0093. |
| R15.04 | Enforce hard accounting, convergence, penetration, finiteness, and determinism gates. | Partial | Existing metrics exist; recovery thresholds and structured failure evidence are incomplete. | PSIM-0093. |
| R15.05 | Pass balanced and quality numeric/performance budgets. | Missing | Must be re-established after validation and correction. | PSIM-0094. |
