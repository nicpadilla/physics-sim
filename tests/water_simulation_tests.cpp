...
int main()
{
...

    {
        ...
        REQUIRE(offline_settings.pressure_relative_residual_target < live_settings.pressure_relative_residual_target, "offline solver settings did not tighten the pressure target");
